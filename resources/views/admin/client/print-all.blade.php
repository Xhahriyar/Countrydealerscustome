        ...
        <div class="d-flex justify-content-center">
            <p style="width: 80%"> Dear Sir/Madam, <br>
                ...
                <span id="banknameInputSpan"
                    style="position: absolute; visibility: hidden; white-space: nowrap;"></span>) to Country Dealers as
                payment against Plot No. ({{ $data->plot_number }}) . Your Payment Status is as Follows:
            </p>
        </div>
