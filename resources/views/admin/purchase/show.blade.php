                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex justify-content-between">
                        <div class="col-md-4">
                            ...
                            <label for="">{{ number_format($data->plot_price) }}</label>
                        </div>
                        <div class="col-md-4">
                            <p><strong for="">Plot Demand</strong></p>
                            <label for="">{{ number_format($data->plot_demand) }}</label>
                        </div>
                        <div class="col-md-4">
                            <p><strong for="">Plot Sale Price</strong></p>
                            <label for="">{{ number_format($data->plot_sale_price) }}</label>
                        </div>
                    </div>
                    <div class="card-body d-flex justify-content-between">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <label for="">{{ number_format($data->adjustment_price) }}</label>
                        </div>
                        <div class="col-md-3">
                            <p><strong for="">Advance Payment</strong></p>
                            <label for="">{{ number_format($data->advance_payment) }}</label>
                        </div>
                        <div class="col-md-3">
                            ...
                            @if ($installment->payment_method === 'cash')
                                <div class="card-body d-flex justify-content-between">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ number_format($installment->installment_payment) }}
                                    </div>
                                    <div class="col-md-3">
                            ...
                            @else
                                ...
                                <div class="card-body d-flex">
                                    <div class="col-md-4">
                                        ...
                                        {{ number_format($installment->cheque_installment_amount) }}
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="card-body d-flex justify-content-between">
                                @if ($payment->payment_method == 'cash')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{ number_format($payment->full_payment) }}
                                    </div>
                            </div>
                        @else
                            <div class="card-body d-flex justify-content-between">
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ number_format($payment->check_amount) }}
                                </div>
                                <div class="col-md-2">
