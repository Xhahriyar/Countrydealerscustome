                                ...
                                <tbody>
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{formatNumberWithCurrencyExtension( $data->plot_sale_price) }}</td>
                                            <td>{{ $data->plot_size }}</td>
                                            <td>{{formatNumberWithCurrencyExtension( $data->adjustment_price + $data->advance_payment + $data->installments->where('status', 'PAID')->sum('cheque_installment_amount') + $data->installments->where('status', 'PAID')->sum('installment_payment')) }}
                                            </td>
                                            <td>{{formatNumberWithCurrencyExtension(
